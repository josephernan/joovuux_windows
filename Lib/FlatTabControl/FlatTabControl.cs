...
namespace FlatTabControl
{
	...
	public class FlatTabControl : System.Windows.Forms.TabControl
	{
		...
		internal void DrawControl(Graphics g)
		{
			...
			//Pen border = new Pen(SystemColors.ControlLight);
            Pen border = new Pen(Color.DarkGray);
            //Pen border = new Pen(Color.LightGray);
		...
		internal void DrawTab(Graphics g, TabPage tabPage, int nIndex)
		{
            ...
            if (this.Alignment == TabAlignment.Top)
            {
                ...
                pt[4] = new Point(recBounds.Right-1, recBounds.Top + 0);
            ...
            Brush br = new SolidBrush(Color.SteelBlue);
            if (nIndex == 0)
            {
                br = new SolidBrush(Color.SteelBlue);
                g.FillPolygon(br, pt);
                br.Dispose();
            }
            else
            ...
            Pen border = new Pen(Color.DarkGray);
            if (bSelected) g.DrawPolygon(border, pt); 
			//g.DrawPolygon(SystemPens.ControlLight, pt);
            ...
            if (nIndex == 0) br = new SolidBrush(Color.WhiteSmoke);
            else br = new SolidBrush(tabPage.ForeColor);
